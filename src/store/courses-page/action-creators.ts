...
import { COURSE_LIST_WRETCH_LOADING, COURSE_LIST_WRETCH_LOADED, COURSE_LIST_WRETCH_FAIL, COURSE_CREATE_CREATE_MODAL_UNVALIDATE_INPUT_DESCRIPTION, COURSE_CREATE_CREATE_MODAL_UNVALIDATE_INPUT_DURATION, COURSE_LIST_OPEN_MODAL_CREATE_COURSE, COURSE_LIST_CLOSE_MODAL_CREATE_COURSE, COURSE_LIST_OPEN_MODAL_DELETE_COURSE, COURSE_LIST_CLOSE_MODAL_DELETE_COURSE, COURSE_LIST_WRETCH_CREATE_COURSE, COURSE_CREATE_NO_NAME_VALIDATED, COURSE_CREATE_NO_DESCRIPTION_VALIDATED, COURSE_CREATE_NO_DURATION_VALIDATED, COURSE_CREATE_INPUT_DATA_NEW_COURSE, COURSE_CREATE_CREATE_MODAL_UNVALIDATE_INPUT_NAME } from "../actionTypes"
