...
export const TextareaStyled = styled(TextareaInput)`
    min-height: 200px;
    max-height: 200px;
    min-width: ${(props: WidthTextarea) => props.width ? props.width + 'px' : '272px'};
    max-width: ${(props: WidthTextarea) => props.width ? props.width + 'px' : '272px'};
`
...
export const NumberInputStyled = styled(InputStyledBase)`
    width: ${(props: WidthNumberInput) => props.width ? props.width + 'px' : '272px'};
`
