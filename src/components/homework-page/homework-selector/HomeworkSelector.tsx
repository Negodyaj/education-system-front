...
import { CourseItem, CourseName, HomeworkItem, HomeworkSelectorContainer, HomeworkThemeName } from "../styled-components/consts"
                        ...
                        appState.homeworkPage.homeworkListMethodist[courseName as keyof HomeworksByCourse].map(hw => {
                            return (
                                <HomeworkItem>
                                    ...
                                    <div>{
                                        hw.themes.map(theme => (
                                            <HomeworkThemeName key={theme.id}>{theme.name}</HomeworkThemeName>
                                        ))
                                    }</div>
